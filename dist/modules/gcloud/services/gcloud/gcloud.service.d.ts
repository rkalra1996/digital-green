...
export declare class GcloudService {
    ...
    private storage;
    constructor(logger: Logger, gcloudSDK: GoogleCloudSdkService, sttSrvc: SpeechToTextService, ltSrvc: LanguageTranslationService, saSrvc: SentimentAnalysisService);
